...
_OBJ = main.o dp_array.o dp_array/space_array_1.o dp_array/space_array_2.o dp_array/space_array_3.o dp_array/space_array_4.o dp_array/space_array_5.o dp_array/space_array.o rec/objects.o rec/objects_2.o list.o elmlist.o rec/dp_rec.o rec/dp_rec2.o #dp_list.o
